...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', metavar='C', type=str, default='/home/alex/Workspace/R-net/source/config/train_config.yml')
    ...
    launch_params['fine_tuning'] = True if args.mode == 'fine_tuning' else False
